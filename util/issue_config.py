...
class Issue_Config:
    ...
    ISSUE_WHOIS_UPDATE_FREQUNCY = config["Domain Whois"]["ISSUE_WHOIS_UPDATE_FREQUNCY"]
    ...
    SUGGESTION_WHOIS_UPDATE_FREQUNCY = config["Domain Whois"]["SUGGESTION_WHOIS_UPDATE_FREQUNCY"]
